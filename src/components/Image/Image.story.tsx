...
const ImageMobileSrc2 = require('../../../public/images/banner-2--mobile.jpg')

const ImageSrc3 = require('../../../public/images/banner-2.1.jpg')
const ImageMobileSrc3 = require('../../../public/images/banner-2.1--mobile.jpg')
...
storiesOf('📦 Components/Image', module)
    ...
    .add('Vertical Scroll', () => (
        <div style={{ display: 'grid', gridGap: '100vh', padding: '10rem' }}>
            <Image alt="" src={{ mobile: ImageMobileSrc1, desktop: ImageSrc1 }} width={600} />
            <Image alt="" src={{ mobile: ImageMobileSrc2, desktop: ImageSrc2 }} width={600} />
            <Image alt="" src={{ mobile: ImageMobileSrc3, desktop: ImageSrc3 }} width={600} />
        </div>
    ))
    .add('Horizontal Scroll', () => (
        <div style={{ display: 'flex', width: '50%', overflow: 'scroll' }}>
            <Image alt="" src={{ mobile: ImageMobileSrc1, desktop: ImageSrc1 }} width={600} />
            <Image alt="" src={{ mobile: ImageMobileSrc2, desktop: ImageSrc2 }} width={600} style={{ marginLeft: '100vw' }} />
            <Image alt="" src={{ mobile: ImageMobileSrc3, desktop: ImageSrc3 }} width={600} style={{ marginLeft: '100vw' }} />
        </div>
    ))
